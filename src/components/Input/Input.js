...
// 각 조건에 맞는 인풋을 렌더링하는 함수로 분리해보세요.
// 너무 길어져서 함수로 분리해야겠다는 생각이 들면 분리해보세요.
// 명확한 함수명을 사용하면, 함수를 보고 무슨 역할을 하는지 쉽게 파악할 수 있습니다.
// 주석으로 함수의 역할을 설명하는 것보다 함수명으로 역할을 설명하는 것이 더 좋습니다.
...
export default class Input {
  ...
  // 반복적으로 어트리뷰트를 추가하는 부분을 함수로 분리해보세요.
  createAttributes() {
    const {
      idName,
      value,
