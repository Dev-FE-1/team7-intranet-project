...
export default function Employee(root) {
  ...
  root.innerHTML = `
    ...
    <div class="modal employee__modal employee__detailModal modal--none">
      <div class="modal__bb employee__mpdalBb"></div>
