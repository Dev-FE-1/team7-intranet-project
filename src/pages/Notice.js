export default function Notice(root) {
  ...
  const cardData = [
    {
      title: '이굿위크 이벤트 공지사항',
      imgUrl: '/public/temp-image.jpg',
      imgAlt: 'puppy',
      content: '이거 데이터 언제 다 만들지',
    },
    {
      title: '강아지 귀엽네요',
      imgUrl: '/public/temp-image.jpg',
      imgAlt: 'puppy',
      content: '지피티 힘내라.. 야무지게 만들어줘',
    },
    {
      title: '장바구니 서비스 점검 일정',
      imgUrl: '/public/temp-image.jpg',
      imgAlt: 'puppy',
      content:
        '데이터 길면 어떻게 나오는지 확인하려고 쓰는거임 동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세 무궁화 삼천리 화려강산 ...더보기 데이터 길면 어떻게 나오는지 확인하려고 쓰는거임 동해물과 백두산이 마르고 닳도록 하느님이 보우하사 우리나라 만세 무궁화 삼천리 화려강산 ...더보기',
    },
    {
      title: '연차 및 복지 혜택 안내',
      imgUrl: '/public/temp-image.jpg',
      imgAlt: 'puppy',
      content:
        '연차 사용 관련 안내: 연차는 최대 30일까지 사용 가능하며, 사용 계획이나 추가 정보가 필요하시면 HR팀에 문의해 주세요.',
    },
    {
      title: '받고',
      imgUrl: '/public/temp-image.jpg',
