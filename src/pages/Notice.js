...
export default function Notice(root) {
  ...
  function renderModal(data){
      ...
      <div class="modal modal--bgWhite notice__modal"> 
        ...
        <div class="modal__inner notice__modal__inner">
          <div class="notice__modal__bar">
          <p class="notice__modal__title">${data.title}</p>
          <p class="notice__modal__date">${data.date}</p>
          <div>
          <div class="modal__content">
            <div class="notice__modal__img">
            <img src="${data.imgs}" alt="${data.imgAlt}"/>
            </div>
            <div class="notice__modal__content">${data.content}</div>
          </div>
  ...
  const cardData=[
  {
    ...
    "date": "2024-06-26",
    "title": "새로운 업데이트 공지",
    "content": " 내용이 길어졌을 때 스크롤이 발생하는지 확인하기 위함입니다. 2024년 6월 26일에 새로운 업데이트가 진행됩니다.2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩2024년 6월 26일에 새로운 업데이트가 진행됩",
